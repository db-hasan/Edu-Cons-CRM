        ...
        <div class="card">
            <div class="d-flex justify-content-between bg-success-subtle px-4 pt-3">
                ...
                <div class="text-end pt-2">
                    <a href="{{ route('branch.index') }}" class="btn btn-primary"><i class="fa-regular fa-eye"></i>
                        View
                        Branch</a>
                </div>
            </div>
            <form method="post" action="" enctype="multipart/form-data" class="row g-3 p-3">
                ...
                <div class="col-md-12 pb-3" id="rowWrapper">
                    ...
                    <div class="d-flex mb-3 rowItem">
                        <input type="text" class="form-control me-2" name="branch[]" placeholder="Branch Name"
