        ...
        <div class="card">
            <div class="d-flex justify-content-between bg-success-subtle px-4 pt-3">
                ...
                <div class="text-end pt-2">
                    <a href="{{ route('language.index') }}" class="btn btn-primary"><i class="fa-regular fa-eye"></i>
                        View
                        Language</a>
                </div>
            </div>
            <form method="post" action="" enctype="multipart/form-data" class="row g-3 p-3">
                ...
                <div class="col-md-8 pb-3">
                    ...
                    <input type="text" class="form-control" name="language" placeholder="language Name"
