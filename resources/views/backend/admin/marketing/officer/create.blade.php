    ...
    <main id="main" class="main">
        <div class="card">
            <div class="d-flex justify-content-between bg-success-subtle px-4 pt-3">
                <div class="pagetitle">
                    <h1>Assign Marketing Officer</h1>
                    <nav>
                        <ol class="breadcrumb">
                ...
                <div class="text-end pt-2">
                    <a href="{{ route('marketing.officer.index') }}" class="btn btn-primary"><i
            ...
            <form method="" action="" enctype="multipart/form-data" class="row g-3 p-3 needs-validation"
                ...
                <div class="col-md-6 pb-3">
                    <label for="country_id" class="form-label">Marketing Officer<span class="text-danger">*</span></label>
                    <select class="js-example-basic-single form-select" name="country_id" id="country_id">
                        <option selected disabled>Select Marketing Officer</option>
                        @foreach ($countries as $key => $country)
                            <option value="{{ $country->id }}">{{ $country->name }}</option>
                        @endforeach
                    </select>
