...
@section('content')
    <main id="main" class="main">
        ...
        <hr>
        <div class="card">
            <form method="post" action="{{ route('subjectmapping.store') }}" enctype="multipart/form-data"
                class="row g-3 p-3">
                @csrf
                ...
                <div class="col-md-12 pb-3" id="rowWrapper">
                    ...
                    <div class="d-flex mb-3 align-items-end rowItem">
                        ...
                        <div class="col-md-2 me-2">
                            <input type="number" class="form-control me-2" name="course_duration[]"
                                placeholder="Course duration" value="" required>
                            @error('course_duration')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-2 me-2">
                            <input type="number" class="form-control me-2" name="admission_fee[]"
                                placeholder="Admission Fee" value="" required>
                            @error('admission_fee')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-5 me-2">
                            <input type="text" class="form-control me-2" name="entry_requirement[]"
                                placeholder="Entry Requirment" value="" required>
